...
typealias ChessmenPosition = [ChessBoardPositionKey: Chessmen]
extension ChessmenPosition {
    var chessmenPositions: [[ChessBoardPositionKey]] {
    ...
    var diplayPositionOnConsole: String {
        ...
        return chessmenPositions.map { keys in
